...
type Batareka struct {
	zaryad string
}
func (b *Batareka) String() string {
	return "[" + strings.Repeat(" ", strings.Count(b.zaryad, "0")) + strings.Repeat("X", strings.Count(b.zaryad, "1")) + "]"
}
...
func main(){
	...
	batteryForTest := &Batareka{zaryad: new}
